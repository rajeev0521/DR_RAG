...
The evaluation protocol was executed across 36 controlled ablation runs (6 methods $\times$ 3 random seeds $\times$ 2 distinct benchmarks: HotpotQA multi-hop QA and QASPER scientific paper QA). Table~\ref{tab:results_hotpot} reports results on the frozen HotpotQA test split, and Table~\ref{tab:results_qasper} reports results on the QASPER test split. All values reflect mean $\pm$ standard deviation across seeds ($s \in \{42, 123, 999\}$). Statistical significance is assessed via paired bootstrap confidence intervals ($B=10{,}000$ resamples, $95\%$ CI) relative to the velocity-only baseline.

\begin{table*}[t]
\centering
\caption{HotpotQA empirical evaluation across 6 ablation arms. All systems share BAAI/bge-small-en-v1.5 embeddings, Qdrant in-memory dense index, and Ollama phi3:mini generator. Mean $\pm$ standard deviation across 3 random seeds.}
\label{tab:results_hotpot}
\begin{tabularx}{\textwidth}{lXXXXXXX}
\toprule
\textbf{Method} & \textbf{Recall@5} & \textbf{MRR} & \textbf{EM} & \textbf{F1} & \textbf{Chunks/doc} & \textbf{Build (s)} & \textbf{Latency (ms)} \\
\midrule
Fixed-size & 0.987 $\pm$ 0.000 & 0.917 $\pm$ 0.000 & 0.200 $\pm$ 0.000 & 0.358 $\pm$ 0.000 & 3.400 $\pm$ 0.000 & 0.297 $\pm$ 0.178 & 1.717 $\pm$ 0.243 \\
Similarity-threshold & 0.980 $\pm$ 0.000 & 0.863 $\pm$ 0.000 & 0.200 $\pm$ 0.000 & 0.324 $\pm$ 0.012 & 10.527 $\pm$ 0.000 & 0.510 $\pm$ 0.006 & 3.972 $\pm$ 0.478 \\
Velocity-only & 1.000 $\pm$ 0.000 & 0.922 $\pm$ 0.000 & 0.200 $\pm$ 0.000 & 0.344 $\pm$ 0.001 & 8.287 $\pm$ 0.000 & 0.383 $\pm$ 0.003 & 2.564 $\pm$ 0.019 \\
Velocity + acceleration & 0.993 $\pm$ 0.000 & 0.912 $\pm$ 0.000 & 0.120 $\pm$ 0.000 & 0.283 $\pm$ 0.002 & 9.040 $\pm$ 0.000 & 0.439 $\pm$ 0.039 & 2.953 $\pm$ 0.111 \\
Full STP & 0.987 $\pm$ 0.000 & 0.897 $\pm$ 0.000 & 0.120 $\pm$ 0.000 & 0.283 $\pm$ 0.001 & 9.313 $\pm$ 0.000 & 0.416 $\pm$ 0.004 & 2.822 $\pm$ 0.015 \\
Full STP + selective context & 0.987 $\pm$ 0.000 & 0.897 $\pm$ 0.000 & \textbf{0.240} $\pm$ \textbf{0.000} & \textbf{0.410} $\pm$ \textbf{0.000} & 9.313 $\pm$ 0.000 & 1.064 $\pm$ 0.605 & 3.210 $\pm$ 0.411 \\
\bottomrule
\end{tabularx}
\end{table*}
...
\begin{table*}[t]
\centering
\caption{QASPER empirical evaluation across 6 ablation arms on long-form scientific documents. Mean $\pm$ standard deviation across 3 random seeds.}
\label{tab:results_qasper}
\begin{tabularx}{\textwidth}{lXXXXXXX}
\toprule
\textbf{Method} & \textbf{Recall@5} & \textbf{MRR} & \textbf{EM} & \textbf{F1} & \textbf{Chunks/doc} & \textbf{Build (s)} & \textbf{Latency (ms)} \\
\midrule
Fixed-size & 0.379 $\pm$ 0.000 & 0.226 $\pm$ 0.000 & 0.040 $\pm$ 0.000 & 0.132 $\pm$ 0.000 & 12.429 $\pm$ 0.000 & 0.390 $\pm$ 0.035 & 2.724 $\pm$ 0.174 \\
Similarity-threshold & 0.294 $\pm$ 0.000 & 0.214 $\pm$ 0.000 & 0.000 $\pm$ 0.000 & 0.076 $\pm$ 0.001 & 29.531 $\pm$ 0.000 & 0.795 $\pm$ 0.059 & 4.198 $\pm$ 0.589 \\
Velocity-only & 0.252 $\pm$ 0.000 & 0.187 $\pm$ 0.000 & 0.000 $\pm$ 0.000 & 0.105 $\pm$ 0.001 & 41.796 $\pm$ 0.000 & 1.005 $\pm$ 0.034 & 5.879 $\pm$ 0.223 \\
Velocity + acceleration & 0.257 $\pm$ 0.000 & 0.164 $\pm$ 0.000 & 0.000 $\pm$ 0.000 & 0.082 $\pm$ 0.004 & 43.347 $\pm$ 0.000 & 1.969 $\pm$ 1.405 & 5.088 $\pm$ 0.589 \\
Full STP & 0.299 $\pm$ 0.000 & 0.180 $\pm$ 0.000 & 0.000 $\pm$ 0.000 & 0.105 $\pm$ 0.002 & 47.959 $\pm$ 0.000 & 1.335 $\pm$ 0.184 & 6.592 $\pm$ 1.072 \\
Full STP + selective context & 0.299 $\pm$ 0.000 & 0.180 $\pm$ 0.000 & 0.000 $\pm$ 0.000 & 0.068 $\pm$ 0.000 & 47.959 $\pm$ 0.000 & 1.527 $\pm$ 0.066 & 6.902 $\pm$ 0.796 \\
\bottomrule
\end{tabularx}
\end{table*}
...
\textbf{RQ1: Does each additional signal improve at least one prespecified metric relative to velocity-only chunking?}
...
\textbf{RQ2: Is any quality change explained by a much larger index or unacceptable latency?}
...
\textbf{RQ3: Do gains vary systematically by document structure?}
